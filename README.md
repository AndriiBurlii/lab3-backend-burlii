...
## Висновок
Створено REST API для обліку витрат, реалізовано моделі та CRUD-операції (SQLAlchemy), налаштовано Docker Compose (API + PostgreSQL), виконано міграції та перевірено ендпоінти через curl і Postman. Звіт оформлено зі скріншотами та колекцією. Проєкт відповідає вимогам варіанту №3.
